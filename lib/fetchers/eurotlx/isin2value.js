...
function fetcher(isin, callback) {
  ...
  request({
    ...
    value = value
      .substr(value.indexOf(VALUE_BEGIN) + VALUE_BEGIN.length + 15, 20)
      .substring(0, value.indexOf(VALUE_END));
    ...
    if (_.isEmpty(value) || value === '-') {
      ...
      value = value
      	.substr(value.indexOf(EOD_VALUE_BEGIN) + EOD_VALUE_BEGIN.length + 15, 20)
      	.substr(0, value.indexOf(EOD_VALUE_END));
    }
